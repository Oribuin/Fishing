...
public class DoubleSerializer {
    ...
    public static ConfigDataSerializer<Double> CONFIG = new ConfigDataSerializer<>() {
        /**
         ...
         */
        @Override
        public @NotNull Double read(@NotNull ConfigurationSection section, @NotNull String path) {
            return section.getDouble(path);
        }
    };

    public static SQLDataSerializer<Double> SQL = new SQLDataSerializer<>() {
        /**
         ...
         */
        @Override
        public void write(@NotNull PreparedStatement statement, int parameterIndex, @NotNull Double value) throws SQLException {
         ...
         */
        @Override
        public @NotNull Double read(@NotNull ResultSet resultSet, @NotNull String columnLabel) throws SQLException {

...
public class FloatSerializer {
    ...
    public static ConfigDataSerializer<Float> CONFIG = new ConfigDataSerializer<>() {
        /**
         ...
         */
        @Override
        public @NotNull Float read(@NotNull ConfigurationSection section, @NotNull String path) {
            return (float) section.getDouble(path);
        }
    };

    public static SQLDataSerializer<Float> SQL = new SQLDataSerializer<>() {
        /**
         ...
         */
        @Override
        public void write(@NotNull PreparedStatement statement, int parameterIndex, @NotNull Float value) throws SQLException {
         ...
         */
        @Override
        public @NotNull Float read(@NotNull ResultSet resultSet, @NotNull String columnLabel) throws SQLException {

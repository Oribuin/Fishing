...
public class ShortSerializer {
    ...
    public static ConfigDataSerializer<Short> CONFIG = new ConfigDataSerializer<>() {
        /**
         ...
         */
        @Override
        public @NotNull Short read(@NotNull ConfigurationSection section, @NotNull String path) {
            return (short) section.getInt(path);
        }
    };

    public static SQLDataSerializer<Short> SQL = new SQLDataSerializer<>() {
        /**
         ...
         */
        @Override
        public void write(@NotNull PreparedStatement statement, int parameterIndex, @NotNull Short value) throws SQLException {
         ...
         */
        @Override
        public @NotNull Short read(@NotNull ResultSet resultSet, @NotNull String columnLabel) throws SQLException {

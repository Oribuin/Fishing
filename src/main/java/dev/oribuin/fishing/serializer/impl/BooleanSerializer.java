...
public class BooleanSerializer {
    ...
    public static ConfigDataSerializer<Boolean> CONFIG = new ConfigDataSerializer<>() {
        /**
         ...
         */
        @Override
        public @NotNull Boolean read(@NotNull ConfigurationSection section, @NotNull String path) {
            return section.getBoolean(path);
        }
    };

    public static SQLDataSerializer<Boolean> SQL = new SQLDataSerializer<>() {
        /**
         ...
         */
        @Override
        public void write(@NotNull PreparedStatement statement, int parameterIndex, @NotNull Boolean value) throws SQLException {
         ...
         */
        @Override
        public @NotNull Boolean read(@NotNull ResultSet resultSet, @NotNull String columnLabel) throws SQLException {

...
public class LongSerializer {
    ...
    public static ConfigDataSerializer<Long> CONFIG = new ConfigDataSerializer<>() {
        /**
         ...
         */
        @Override
        public @NotNull Long read(@NotNull ConfigurationSection section, @NotNull String path) {
            return section.getLong(path);
        }
    };

    public static SQLDataSerializer<Long> SQL = new SQLDataSerializer<>() {
        /**
         ...
         */
        @Override
        public void write(@NotNull PreparedStatement statement, int parameterIndex, @NotNull Long value) throws SQLException {
         ...
         */
        @Override
        public @NotNull Long read(@NotNull ResultSet resultSet, @NotNull String columnLabel) throws SQLException {

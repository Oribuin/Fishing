...
import dev.oribuin.fishing.model.fish.condition.impl.AugmentCondition;
import dev.oribuin.fishing.model.fish.condition.impl.BiomeCondition;
import dev.oribuin.fishing.model.fish.condition.impl.BoatCondition;
import dev.oribuin.fishing.model.fish.condition.impl.DepthCondition;
import dev.oribuin.fishing.model.fish.condition.impl.EnvironmentCondition;
import dev.oribuin.fishing.model.fish.condition.impl.HeightCondition;
import dev.oribuin.fishing.model.fish.condition.impl.IceFishingCondition;
import dev.oribuin.fishing.model.fish.condition.impl.LightLevelCondition;
import dev.oribuin.fishing.model.fish.condition.impl.PermissionCondition;
import dev.oribuin.fishing.model.fish.condition.impl.PlaceholderCondition;
import dev.oribuin.fishing.model.fish.condition.impl.TimeCondition;
import dev.oribuin.fishing.model.fish.condition.impl.WeatherCondition;
import dev.oribuin.fishing.model.fish.condition.impl.WorldCondition;
